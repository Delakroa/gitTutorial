...
# список unprinted_designs, а его копию. Список completed_models заполняется
...
#     """Вызов списка заказанных дополнений."""
# print(toppings)

# make_pizza('pepperoni')
# make_pizza('mushroom', 'green peepper', 'extra cheese')
...
# команды print в теле функции показывает, что Python успешно справляется
...
# стоять в списке до параметра *toppings:


# def make_pizza(size, *toppings):
#     print("\nСоздание " + str(size) + "-дюймовой пицца со следующими начинками:")
#     for topping in toppings:
#         print("- " + topping)
#
...
# size. Все остальные значения, следующие за ним, сохраняются в кортеже toppings.
...
# user_profile = build_profile('albert', 'einstein', location='princeton', field='phusics')
# print(user_profile)
...
# def sandvich(*ingredients):
#     """ингридиенты сэндвича"""
#     print("ингридиенты сэндвича: ")
#     for ingredient in ingredients:
#         print("----" + ingredient + "----")


# sandvich('булка', 'сыр', 'колбаса')
# print("\n")
# sandvich('булка', 'грибы')
# print("\n")
# sandvich('сало')
...
# модуль в свою программу. Команда import сообщает Python, что код модуля дол-
...
# ей make_pizza(). Для этого из файла pizza.py следует удалить все, кроме функции
# make_pizza():
...
# В процессе обработки этого файла строка import pizza приказывает Python от-
...
# функция, определенная в pizza.py, будет доступна в making_pizzas.py.
# Чтобы вызвать функцию из импортированного модуля, укажите имя модуля
# (pizza), точку и имя функции (make_pizza()), как показано в строке . Код вы-
...
# точно включить вызов mp() — Python выполнит код make_pizza() без конфликтов
...
# ние от имени
# модуля и помогает сосредоточиться на содержательных именах
...
# Звездочка в команде import приказывает Python скопировать каждую функцию
